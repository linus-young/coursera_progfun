...
class ListsSuite extends FunSuite {
  ...
  test("one plus one is three?") {
    assert((1 + 1 == 3) === false) // This assertion fails! Go ahead and fix it.
  }
  ...
  test("sum of a few numbers") {
    ...
    assert(sum(List(1, 4, 2, 3)) === 10)
    assert(sum(List(1, 4, 4, 3)) === 12)
    assert(sum(List(4, 4, 4, 4, 4)) === 20)
    assert(sum(List(1, 8, 16, 200, 3032)) === 3257)
    assert(sum(List(1, 8, 16, 200, 3032, 0, 0, 0)) === 3257)
    assert(sum(List(-1, -3, -9, 9, 2)) === -2)
    assert(sum(List()) === 0)
  }
  ...
  test("max of a few numbers") {
    ...
    assert(max(List(3, 2, 1, 4)) === 4)
    assert(max(List(1, 3, 4, 2)) === 4)
    assert(max(List(4, 1, 2, 3)) === 4)
    assert(max(List(0, 0, 0, 0)) === 0)
    assert(max(List(1, 5, 23, 82, 198, 234, 73)) === 234)
    assert(max(List(-1, -3, -5, -6)) === -1)
    assert(max(List(-1, 0, -4, -5)) === 0)
    assert(max(List(-5, -4, 9, 8)) == 9)
  }
